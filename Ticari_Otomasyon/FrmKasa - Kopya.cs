...
namespace Ticari_Otomasyon
{
    public partial class FrmKasa : Form
    {
        ...
        private void FrmKasa_Load(object sender, EventArgs e)
        {
            ...
            //Toplam Firma Sayısı
            SqlCommand komut5 = new SqlCommand("Select Count(*) From tbl_FIRMALAR", sql.Connection());
            ...
            SqlCommand komut6 = new SqlCommand("Select Count(Distinct(IL)) From tbl_FIRMALAR", sql.Connection());
